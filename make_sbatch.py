...
parser.add_argument('--sbatch_dir', type=str, help='bash file of commands', default='/scratch/yl11330/personalized_diffusion/sbatch_files')
...
for bash_file in args.bash_files:
    # filter lines
    lines = open(bash_file, 'r').readlines()
    lines = [l.strip() for l in lines if l.strip()]
    lines = [l for l in lines if 'Submitted batch job' not in l]
    # just for assertions
